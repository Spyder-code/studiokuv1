...
<head>
  ...
  <title>Halaman Pemilik studio</title>
...
<!-- JavaScript -->
  ...
  <link rel="icon" href="{{asset('image/Studioku.png')}}">
...
<body id="page-top">
   <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light topbar static-top shadow" style="background-color: #237a88">
          <img src="{{asset('image/Studioku.png')}}" class="rounded-circle mr-sm-2" style="width: 40px; height: 40px;">
        <a class="navbar-brand" href="home.html">Studioku</a>
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #17a2b8">
      ...
      <li class="nav-item @yield('pesanan')">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="{{url('transaksi')}}">Semua transaksi</a>
              <a class="collapse-item" href="{{url('pendding')}}">Belum Dibayar</a>
              <a class="collapse-item" href="{{url('accept')}}">Sudah dikonvirmasi</a>
          </div>
        </div>
      </li>

      <!-- Nav Item - Charts -->
      <li class="nav-item @yield('studio')">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="{{url('logoutMitra')}}">Logout</a>
      </div>
    </div>
  </div>
</div>
